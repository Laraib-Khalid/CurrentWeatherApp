using CurrentWeatherApp.Helpers;
...
namespace CurrentWeatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        private async void GetBackground()
        {
            ...
            var result = await ApiCaller.Get(url, "563492ad6f9170000100000135b589a179694c9e9a46b2cd4bdb4297");

            if(result.Successful)
            {
                var BgInfo = JsonConvert.DeserializeObject<BakgroundInfo>(result.Response);
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/weather?q={Location}&appid=4073eaca885bf35e01c069c457959bba&units=metric";
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q={Location}&appid=4073eaca885bf35e01c069c457959bba&units=metric";
            var result = await ApiCaller.Get(url);
